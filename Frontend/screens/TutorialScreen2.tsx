...
export default function TutorialScreen2({ navigation }: any) {
  const goToNext = useCallback(() => {
    // Move to the next tutorial screen. Final screen will persist the flag.
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.titleBlock}>
          <Text style={styles.title}>설정 &gt; 개인용 핫스팟</Text>
        </View>
        ...
        <Image
          source={require("../assets/tutorial_hotspot1.png")}
          style={styles.image}
          resizeMode="contain"
        />
...
const styles = StyleSheet.create({
  ...
  image: { width: "100%", height: 300, marginTop: 8 },
  button: {
